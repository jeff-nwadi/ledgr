...
import { product, customer } from "@/lib/db/schema";
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-12">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold font-heading text-text-primary">Point of Sale</h1>
          <p className="text-[13px] text-text-muted mt-1">Log new sales, record waste, and process transactions.</p>
        </div>
      </div>

      <SalesPOS products={productsList} customers={customersList} />
    </div>
  );
}
