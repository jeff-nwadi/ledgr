        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-start md:gap-16">
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              ...
              <span className="text-[12px] text-text-muted">4 products</span>
            </div>
            <div className="overflow-x-auto rounded-xl border border-border">
              <table className="w-full min-w-[640px] text-sm tabular-nums">
                <thead>
                  <tr className="bg-[color-mix(in_srgb,var(--surface)_50%,var(--text-primary)_5%)] text-left text-[11px] uppercase tracking-wider text-text-muted">
                    <th className="px-3 py-2.5 font-semibold">Product</th>
                    <th className="px-2 py-2.5 text-right font-semibold">
                      Mon ↓
                    </th>
                    <th className="border-l-2 border-brand bg-[color-mix(in_srgb,var(--brand)_8%,transparent)] px-2 py-2.5 text-right font-semibold text-brand">
                      Tue open
                    </th>
                    <th className="px-2 py-2.5 text-right font-semibold">
                      Added
                  ...
                  {LEDGER_ROWS.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="border-l-2 border-brand bg-[color-mix(in_srgb,var(--brand)_8%,transparent)] px-2 py-2.5 text-right font-semibold text-brand">
                        ...
                        <td className="px-2 py-2.5 text-right font-semibold text-text-primary">
                          {formatQty(r.tueCalc)}
                        </td>
                        <td
                          className={
