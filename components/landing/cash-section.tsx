            ...
            >
              <div className="grid grid-cols-2">
                <div className="border-r border-border p-4 sm:p-5">
                  <p className="text-[10px] sm:text-[12px] font-medium uppercase tracking-wider text-text-muted">
                    Expected
                  </p>
                  <p className="mt-1.5 font-heading text-xl sm:text-3xl font-bold leading-none tabular-nums text-text-primary">
                    ₦48,200
                  </p>
                  <p className="mt-1.5 text-[10px] sm:text-[12px] text-text-muted font-normal">
