          ...
          <div className="order-2 w-full">
            ...
            >
              <div className="mb-3 flex items-center justify-between">
                <h3 className="font-heading text-sm sm:text-base font-bold leading-snug text-text-primary">
                  Customer balances
                </h3>
                <span className="text-[11px] text-text-muted font-medium">3 active</span>
              </div>
              <ul className="divide-y divide-border">
                {CUSTOMERS.map((c) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <p className="text-xs sm:text-sm font-semibold text-text-primary">{c.name}</p>
                        <p className="text-[11px] text-text-muted">{c.status}</p>
                      </div>
                      <p
                        className={
