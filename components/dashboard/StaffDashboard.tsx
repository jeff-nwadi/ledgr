...
export function StaffDashboard({
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="w-64 border-r border-border bg-surface flex flex-col justify-between p-5 sticky top-0 h-screen flex-shrink-0">
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-border/50">
            ...
            {shopCode && (
              <span className="text-[10px] font-mono font-bold bg-brand/10 text-brand px-2 py-0.5 rounded-full border border-brand/20">
                {shopCode}
              </span>
            )}
          </div>
          ...
          <nav className="space-y-1">
            ...
            >
              ...
              {!isOpeningDone && <Lock className="w-3 h-3 text-amber-500" />}
            </button>
        ...
        <div className="pt-4 border-t border-border/50 space-y-3">
          ...
          <form action={async () => { await signOutAction(); }}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 px-3 py-2 text-xs font-semibold text-rose-600 hover:bg-rose-500/10 rounded-xl border border-rose-500/20 transition-colors"
            >
