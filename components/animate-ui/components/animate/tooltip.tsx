...
function TooltipContent({
  ...
  return (
    <TooltipContentPrimitive
      className={cn(
        'z-50 w-fit bg-surface border border-border/50 text-text-primary rounded-md shadow-md',
        className,
      )}
      {...props}
    >
      ...
      <TooltipArrowPrimitive
        className="fill-surface stroke-border/50 stroke-[0.5px] size-3 data-[side='bottom']:translate-y-[1px] data-[side='right']:translate-x-[1px] data-[side='left']:translate-x-[-1px] data-[side='top']:translate-y-[-1px]"
        tipRadius={2}
      />
    </TooltipContentPrimitive>
  );
